...
public class FTPService {
    ...
    public void downloadFile(String hostFileFullName, String fileName, String localDir)
            throws Exception {
        try(FileOutputStream output = new FileOutputStream(new File(hostFileFullName))){
        this.ftp.retrieveFile(localDir + fileName,output);
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        FTPController ftpUploader = new FTPController("127.0.0.1", "test", "1234");
