...
<div class="login-form">
    <form action="/javas/login" method="post">
        <h2 class="text-center">잉력시장 회원이 아니시면, 회원가입해주세요.</h2>   
        ...
        <p class="text-center">소셜로그인</p>
        <div class="text-center social-btn">
            <a href="#" class="btn btn-primary"><i class="fa fa-facebook"></i>&nbsp; 페이스북</a>
            <a href="#" class="btn btn-info"><i class="fa fa-naver"></i>&nbsp; 네이버</a>
			<a href="#" class="btn btn-danger"><i class="fa fa-google"></i>&nbsp; 구글</a>
        </div>
    </form>
</div>
</body>
