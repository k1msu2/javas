...
<form method="post" action="/javas/jobad">
	...
	내용 : <input type="text" name="post_content">
	<input type="hidden" name="post_location" value="${sessionScope.loginVO.mem_address}"><br>
	시급 : <input type="number" name="post_payment"><br>
	<input type="hidden" name="post_phone" value="${sessionScope.loginVO.mem_phone}"><br>
