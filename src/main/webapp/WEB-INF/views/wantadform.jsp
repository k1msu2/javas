    ...
    <div class="form-area">  
        ...
        <br style="clear:both">
                    ...
                    <div class="form-group">
						 <input class="form-control" type="text"  id="mem_userid" name="mem_userid" placeholder="이름">
					</div>
					<div class="form-group">
						 <input class="form-control" type="hidden" id="post_title" name="post_title" placeholder="제목">
					</div>
					<div class="form-group">
                    ...
                    <div class="form-group">
                    <input class="form-control" type="num" id="post_payment" name="post_payment" placeholder="희망 시급">                  
                    </div>
                    <div class="form-group">
						<input class="form-control" type="text" id="post_location" name="post_location" placeholder="구직 희망 지역">
					</div>
					<div class="form-group">
						<input class="form-control" id="post_id" type="text" name="newsid" style="display: none">
					</div>
		<div style="text-align:center;">
        <button type="sumit" onclick="reqInsertWantad()" class="btn btn-primary pull-right" style="margin-right: 10px;">등록</button>
        <input type="reset" value="다시 쓰기" class="btn btn-primary pull-right" style="margin-right: 10px;">
        <input type="button" value="작성 취소" onclick="location.href='wantad/form'"  class="btn btn-primary pull-right" style="margin-right: 10px;">
        </div>
        </form>
    </div>
</div>
